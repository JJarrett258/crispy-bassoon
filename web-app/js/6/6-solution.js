...
const evaluate = (customsDeclarationForms) => {
...
const evalulatePartTwo = (customerDeclarationForms) => {
    ...
    customerDeclarationForms.forEach(group => {
        ...
        let responseToCompareAgainst = individualResponses.reduce(function (a, b) {
